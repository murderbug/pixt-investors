...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Pixt | Download the Pixt SMR Patent</title>
                           ...
                           <!-- Single Post -->
                            <article class="entry">                               
								...
								<div class="post-excerpt">
									<h3 class="color">Simple Mobile Registration patent information</h3>
									...
									<p>Simple Mobile Registration (SMR) is an invention to simplify the registration process on mobile devices by providing users an option register for a service or app with a single tap.</p>
									<p>Very simply, when a user taps an SMR-enabled registration link or button, the app will check a third-party user database to validate whether the user exists in the system. If the user is authenticated through their "unique ID", they are granted access to the app or service.</p>
									<p>If the user's account is not found, they are redirected back, and informed that they're not currently registered in the third-party system (and possibly given other methods to register).</p>
									<?php include 'includes/confidentiality-notice.php' ?>
									
									
									<p class="text-center"><a class="btn btn-transparent " href="download.php?id=4&userId=<?php echo($userId) ?>" target="_blank" download>I Agree</a> &nbsp; <a class="btn btn-transparent " href="logout.php?logout">No thanks</a></p>
								</div>
                            </article>
